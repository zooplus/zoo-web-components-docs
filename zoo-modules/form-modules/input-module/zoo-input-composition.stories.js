...
import mdx from './zoo-input-composition.mdx';
import { html } from 'lit-html';
import Input from '@zooplus/zoo-web-components';

export default {
	title: 'Docs/Input Composition',
	component: 'zoo-input',
...
export const zooInput = () => {
	...
	let buttonLabel = text('buttonLabel', 'Button label', attributesGroupId);
